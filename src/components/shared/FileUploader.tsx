...
const FileUploader=({fieldChange,mediaUrl}:FileUploaderProps)=>{
    ...
    return (
        <div {...getRootProps()} className='flex flex-center flex-col bag-dark-3 rounded-xl cursor-pointer'>
      <input {...getInputProps()} className='cursor-pointer'/>
      {
        fileUrl ? (
            ...
            <p className='file_uploader-label'>Click and drag photo to replace</p>
            </>
        ):(
